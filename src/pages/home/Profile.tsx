...
import {selectGmail, toggleDarkMode} from '../../store/gmailActions';
import {GmailAPI} from "../../api/GmailAPI";

/**
 * Profile page component with user profile, theme toggle and sign out options
 */
const Profile: React.FC = () => {
  ...
  // Define dashboard tiles configuration with only theme and sign out
  ...
  const toggleTheme = async () => {
    try {
      const success = await GmailAPI.updateDarkMode(!appConfig.darkMode);
      if (success) {
        toggleDarkMode();
      } else {
