...
/**
 * Adds a new jsonData by calling the 'addjsonDataData' cloud function.
 *
 * @param {object} jsonData - The jsonData object to be added.
 ...
 */
const addJson = (jsonData, accessToken) => {
    return callCloudFunction('addJsonData', jsonData, accessToken);
}
